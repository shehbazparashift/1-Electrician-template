        ...
        <>
          ...
          <div className="fixed inset-0 z-[301] flex items-center justify-center p-3 sm:p-5 lg:p-6 pointer-events-none">
            <motion.div
              ...
              className="relative w-full max-w-[620px] bg-[#FAF9F5]/95 backdrop-blur-xl rounded-[24px] shadow-[0_28px_90px_rgba(7,17,31,0.28)] pointer-events-auto overflow-hidden flex flex-col max-h-[calc(100dvh-24px)] sm:max-h-[calc(100dvh-40px)] border border-white/70 ring-1 ring-black/[0.04]"
              role="dialog"
              aria-modal="true"
              aria-label={t({
            ...
            >
              {/* ── Header ── */}
              <div
                className="relative shrink-0 px-6 lg:px-8 pt-5 pb-5 text-[var(--color-blue)] overflow-hidden"
              ...
              >
                ...
                <div className="relative flex items-start justify-between gap-4 text-white">
                  <div>
                    <p className="text-[11px] uppercase tracking-[2px]  font-['Inter'] mb-1">
                      {step === "success"
                    ...
                    <h2 className="font-['Inter'] font-semibold text-[clamp(20px,3.8vw,24px)] leading-[1.15]">
                      {step === "service" &&
                  ...
                  <button
                    ...
                    className="shrink-0 -m-2 inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/15  text-[var(--color-blue)]/80 hover:text-[var(--color-blue)] hover:bg-white/15 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70 transition-colors cursor-pointer"
                  >
                    <svg
                      width="20"
                      height="20"
...
function ServiceStep({
  ...
  return (
    <div className="flex flex-col gap-4 justify-between flex-1">
      ...
      {!loading && !error && (
        <>
          <p className="font-['Inter'] text-[13px] text-[var(--color-muted)] -mt-1 ">
            {t({
          ...
          <div className="grid grid-cols-1 gap-2.5 max-h-[340px] overflow-y-auto pr-1">
            {services.length === 0 && (
              <div className="rounded-xl border border-[var(--color-border)] bg-[#FAF9F5] px-4 py-3 text-[13px] text-[var(--color-body)]">
                {t({
              ...
              return (
                <button
                  ...
                  className={
                    ...
                    // (active
                    //   ? "border-[var(--color-blue)] bg-[var(--color-blue)] shadow-[0_8px_24px_-12px_rgba(43,92,230,0.4)]"
                    //   : "border-[var(--color-border)] bg-white hover:border-[var(--color-blue)] hover:bg-[var(--color-blue-light)]")
                    (active
                      ? "border-[var(--color-blue)] bg-white text-[var(--color-blue)] shadow-[0_8px_24px_-12px_rgba(43,92,230,0.4)]"
                      : "border-[var(--color-border)] bg-white hover:border-[var(--color-blue)] hover:bg-[var(--color-blue-light)]")
                  }
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <div
                        className={`font-['Inter'] font-semibold text-[15px] ${active ? "text-[var(--color-blue)]" : "text-[var(--color-ink)]"}`}
                      >
                        {s.name}
                      </div>
                      {s.description && (
                        <div
                          className={`mt-0.5 font-['Inter'] text-[12.5px] leading-[1.45] line-clamp-2 ${active ? "text-[var(--color-blue)]/80" : "text-[var(--color-body)]"}`}
                        >
                          {s.description}
                        </div>
                      )}
                      <div
                        className={`mt-1.5 flex flex-wrap items-center gap-x-3 gap-y-1 font-['Inter'] text-[12px] ${active ? "text-[var(--color-blue)]/70" : "text-[var(--color-muted)]"}`}
                      >
                        ...
                        {price && (
                          <span
                            className={`inline-flex items-center gap-1 font-medium ${active ? "text-[var(--color-blue)]/90" : "text-[var(--color-blue)]"}`}
                          >
                            {price}
                          </span>
                        )}
                    ...
                    <span
                      className={
                        ...
                        (active
                          ...
                          : "border-[var(--color-border)] bg-[#FAF9F5]")
                      }
                    >
                      {active && (
                        <motion.svg
      ...
      <div className="flex items-center justify-end gap-3 pt-2 mt-auto">
        <Button
          ...
          disabled={!serviceId}
          arrow="right"
          className="cursor-pointer !bg-[var(--color-blue)] hover:!bg-[var(--color-blue-dark)] text-white py-2 px-5 rounded-[10px] disabled:opacity-50 disabled:cursor-not-allowed disabled:translate-y-0"
        >
    ...
    <div className="flex flex-col gap-5 flex-1">
      ...
      {!loading && !error && (
        <>
          ...
          <div>
            {selectedDate && (
              <p className="mb-1 font-['Inter'] font-semibold text-[13px] text-[var(--color-ink)]">
            ...
            <p className="mb-2 font-['Inter'] text-[11.5px] uppercase tracking-[1.4px] text-[var(--color-muted)] font-semibold">
            ...
            {!selectedDate ? (
              <div className="rounded-xl border border-[var(--color-border)] bg-[#FAF9F5] px-4 py-5 text-center">
                <p className="font-['Inter'] text-[13px] text-[var(--color-muted)]">
                  {t({
                  ...
                  return (
                    <motion.button
                      ...
                      className={
                        ...
                        (active
                          ? "border-[var(--color-blue)] bg-[var(--color-blue)] text-white shadow-[0_8px_20px_-10px_rgba(43,92,230,0.45)]"
                          : "border-[var(--color-border)] bg-white text-[var(--color-ink)] hover:border-[var(--color-blue)] hover:bg-[var(--color-blue-light)]")
                      }
                    >
          ...
          <div className="flex items-center justify-between gap-3 mt-auto pb-2">
            <button
              type="button"
              onClick={onBack}
              className="font-['Inter'] text-[13px] font-medium text-[var(--color-body)] border border-[var(--color-border)] px-4 py-2 rounded-[10px] hover:border-[var(--color-blue)] hover:text-[var(--color-blue)] transition-colors cursor-pointer"
            >
              {t({ en: "← Back", nl: "← Terug" })}
            </button>
            <Button
              ...
              arrow="right"
              className="cursor-pointer !bg-[var(--color-blue)] hover:!bg-[var(--color-blue-dark)] text-white py-2 px-4 rounded-[10px] disabled:opacity-50 disabled:cursor-not-allowed disabled:translate-y-0"
            >
              {t({ en: "Continue", nl: "Doorgaan" })}
            </Button>
          </div>
...
function Calendar({
  ...
  const navBtnClass =
    "inline-flex items-center justify-center w-[32px] h-[32px] rounded-lg border border-[var(--color-border)] text-[var(--color-ink)] hover:border-[var(--color-blue)] hover:bg-[var(--color-blue-light)] disabled:opacity-30 disabled:cursor-not-allowed transition-colors cursor-pointer";

  return (
    <div className="rounded-2xl border border-[var(--color-border)] bg-[#FAF9F5] p-3 lg:p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="font-['Inter'] font-semibold text-[14.5px] text-[var(--color-ink)]">
          {monthLabel}
        </div>
        <button
          type="button"
      ...
      <div className="grid grid-cols-7 gap-1 mb-1">
        {(locale === "nl"
          ...
          <div
            key={i}
            className="text-center font-['Inter'] text-[10.5px] uppercase tracking-[1px] text-[var(--color-muted)] py-1"
          >
            {d}
          </div>
        ))}
        ...
        {cells.map((cell, i) => {
          ...
          return (
            <button
              ...
              className={
                "relative h-9 rounded-lg font-['Inter'] text-[13px] transition-all " +
                (active
                  ? "bg-[var(--color-blue)] text-white font-semibold shadow-[0_8px_20px_-10px_rgba(43,92,230,0.5)] cursor-pointer"
                  : available && inRange
                    ? "bg-white text-[var(--color-ink)] hover:bg-[var(--color-blue-light)] hover:text-[var(--color-blue)] font-medium cursor-pointer"
            ...
            >
              ...
              {!active && available && inRange && (
                <span
                  aria-hidden
                  className="absolute left-1/2 -translate-x-1/2 bottom-[3px] w-[3px] h-[3px] rounded-full bg-[var(--color-blue)]"
                />
              )}
              {!active && isToday && (
                <span
                  aria-hidden
                  className="absolute inset-[2px] rounded-lg ring-1 ring-[var(--color-blue)] pointer-events-none"
                />
              )}
            </button>
          );
...
function DetailsStep({
  ...
  const inputClass = (hasError: boolean) =>
    "w-full h-[44px] px-3.5 rounded-xl border font-['Inter'] text-[14px] text-[var(--color-ink)] bg-white focus:outline-none focus:ring-2 transition-all placeholder:text-[var(--color-muted)] " +
    (hasError
      ? "border-red-400 focus:border-red-400 focus:ring-red-400/20"
      : "border-[var(--color-border)] focus:border-[var(--color-blue)] focus:ring-[var(--color-blue)]/15");
  ...
  return (
    ...
    >
      {service && slot && (
        <div className="flex items-center gap-2.5 rounded-xl bg-[var(--color-blue-light)] border border-[var(--color-blue)]/20 px-3 py-2.5">
          <span className="inline-flex items-center justify-center w-[32px] h-[32px] rounded-lg text-[var(--color-blue)] shrink-0 bg-[var(--color-blue)]">
            <svg
              width="15"
              height="15"
              viewBox="0 0 24 24"
          ...
          <div className="min-w-0 flex-1">
            <div className="font-['Inter'] font-medium text-[13px] text-[var(--color-ink)] truncate">
              {service.name}
            </div>
            <div className="font-['Inter'] text-[12px] text-[var(--color-muted)] truncate">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        <div className="space-y-1.5">
          <label className="font-['Inter'] font-medium text-[12.5px] text-[var(--color-body)]">
        ...
        <div className="lg:col-span-2 space-y-1.5">
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3.5 py-3 rounded-xl border border-[var(--color-border)] bg-white font-['Inter'] text-[14px] text-[var(--color-ink)] focus:outline-none focus:border-[var(--color-blue)] focus:ring-2 focus:ring-[var(--color-blue)]/15 transition-all resize-none"
          />
        </div>
      </div>
      {error && (
      ...
      <div className="flex items-center justify-between gap-3 pt-1 pb-2 mt-auto">
        <button
          ...
          onClick={onBack}
          disabled={submitting}
          className="font-['Inter'] text-[13px] font-medium text-[var(--color-body)] border border-[var(--color-border)] px-4 py-2 rounded-[10px] hover:border-[var(--color-blue)] hover:text-[var(--color-blue)] transition-colors cursor-pointer disabled:opacity-50"
        >
          {t({ en: "← Back", nl: "← Terug" })}
        </button>
        <button
          type="submit"
          disabled={!canSubmit}
          className="font-['Inter'] font-semibold text-[14px] text-white py-2.5 px-6 rounded-[10px] bg-[var(--color-blue)] hover:bg-[var(--color-blue-dark)] transition-colors cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed shadow-[var(--shadow-btn)]"
        >
          {submitting ? (
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center gap-4 py-2 flex-1">
      <motion.div
        ...
        className="w-[68px] h-[68px] rounded-full flex items-center justify-center text-white bg-[var(--color-blue)] shadow-[0_18px_40px_-12px_rgba(43,92,230,0.45)]"
      >
        <motion.svg
      ...
      <div className="flex flex-col gap-1.5">
        <h3 className="font-['Inter'] font-semibold text-[22px] leading-[1.2] text-[var(--color-ink)]">
          {t({ en: "Thanks", nl: "Bedankt" })}
          {name ? `, ${name.split(" ")[0]}` : ""}!
        </h3>
        <p className="font-['Inter'] text-[14px] leading-[1.5] text-[var(--color-body)] max-w-[420px]">
          {t({
      ...
      {(service || slot) && (
        <div className="w-full max-w-[420px] mt-2 rounded-2xl border border-[var(--color-border)] bg-[#FAF9F5] px-4 py-3 text-left">
      ...
      <button
        onClick={onClose}
        className="mt-3 font-['Inter'] font-semibold text-[14px] text-white py-2.5 px-8 rounded-full bg-[var(--color-blue)] hover:bg-[var(--color-blue-dark)] transition-colors cursor-pointer shadow-[var(--shadow-btn)]"
      >
        {t({ en: "Done", nl: "Klaar" })}
      </button>
    </div>
...
function SummaryRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-col">
      <span className="font-['Inter'] text-[11px] uppercase tracking-[1px] text-[var(--color-muted)]">
        {label}
      </span>
      <span className="font-['Inter'] font-medium text-[13.5px] text-[var(--color-ink)] mt-0.5">
        {value}
      </span>
    </div>
  );
