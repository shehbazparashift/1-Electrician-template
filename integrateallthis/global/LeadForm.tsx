        ...
        <>
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-[660px] bg-[#FAF9F5]/95 backdrop-blur-xl rounded-[24px] shadow-[0_28px_90px_rgba(7,17,31,0.28)] overflow-hidden pointer-events-auto flex flex-col max-h-[calc(100dvh-24px)] sm:max-h-[calc(100dvh-40px)] border border-white/70 ring-1 ring-black/[0.04]"
              role="dialog"
              aria-modal="true"
              aria-label={t({ en: "Contact us", nl: "Neem contact op" })}
            >
              {/* Header */}
              <div className="relative shrink-0 px-5 sm:px-7 lg:px-9 pt-6 pb-5 overflow-hidden bg-[var(--color-blue)]">
                ...
                <div className="relative flex items-start justify-between gap-4">
                  <div>
                    <p className="text-[11px] uppercase tracking-[2px] text-white/60 font-['Inter'] mb-1">
                      {t({ en: "Get in touch", nl: "Neem contact op" })}
                    </p>
                    <h2 className="font-['Inter'] font-semibold text-[clamp(20px,4vw,26px)] leading-[1.15] text-white">
                      {t({
                        en: "Let's connect",
