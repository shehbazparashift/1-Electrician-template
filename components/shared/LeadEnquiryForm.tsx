...
//         <fieldset className="space-y-2 lg:space-y-0 lg:col-span-2 lg:flex lg:gap-5 lg:my-1 lg:items-center rounded-2xl border border-[var(--m-border)] bg-white/55 px-4 py-3">
//           <legend className="px-1 text-[12.5px] font-semibold text-[var(--m-fg-muted)] font-sans">
//             {t({
