...
const CONTENT = {
  en: {
    heading: "Book an electrician in under a minute.",
    paragraph:
      "Tell us what you need and choose a convenient time. We'll confirm your appointment quickly.",
    bookAppointment: "Book appointment",
    imageAlt: "Electrician fixing light fixture",
  },
  nl: {
    heading: "Boek een elektricien in minder dan een minuut.",
    paragraph:
      "Vertel ons wat je nodig hebt en kies een geschikt tijdstip. We bevestigen je afspraak snel.",
    bookAppointment: "Afspraak maken",
    imageAlt: "Elektricien repareert lichtarmatuur",
  },
} as const;
